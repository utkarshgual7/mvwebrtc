...
const MeetingTypeList = () => {
  ...
  const createMeeting = async () => {
    ...
    try {
      ...
      if (!values.description) {
        router.push(`/meeting/${call.id}?name=${encodeURIComponent(values.name)}`);
      }
      toast({
  ...
  const renderScheduleMeetingModal = () => {
    if (!callDetail && meetingState === 'isScheduleMeeting') {
      return (
        <MeetingModal
          isOpen={true}
  ...
  const renderInstantMeetingModal = () => {
      ...
      return (
        <MeetingModal
          ...
          handleClick={() => {
            ...
            router.push(`${values.link}?name=${encodeURIComponent(values.name)}`);
          }}
        >
          <div className="space-y-4">
            <div className="flex flex-col gap-2.5">
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        ...
        {renderMeetingCreatedModal()}
        {renderInstantMeetingModal()}
